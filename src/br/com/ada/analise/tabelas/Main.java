...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            imprimirResultado(analiseService.jogadorComMaisGols("Gol"), "Jogador que mais fez gols");
            imprimirResultado(analiseService.jogadorComMaisGols("Penalty"), "Jogador que mais fez gols de pênalti");
            imprimirResultado(analiseService.jogadorComMaisGols("Contra"), "Jogador que mais fez gols contras");
